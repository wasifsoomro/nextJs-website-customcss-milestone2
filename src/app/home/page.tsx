...
export default function Home() {
  ...
  return (
    <div className={styles.page}>
        ...
        <div className={styles.headingContainer}>
          ...
          <div data-aos="flip-right" className={styles.para}>
            ...
            <p className={styles.l3}>
              {" "}
              is my first website, and I’m excited to
            </p>
      ...
      <div className={styles.cards}>
        <div data-aos="fade-right" className={styles.card1}>
         ...
         <Image
          ...
          <p className={styles.aboutpara}>
            ...
            this website marks the beginning of my journey.
          </p>
        </div>
        <div data-aos="fade-left" className={styles.card2}>
          ...
          <div className={styles.htmlcssImage}>
            <Image src="/html-logo.png" alt="myImage" width={100} height={80} />
            <Image src="/csslogo.jpeg" alt="myImage" width={100} height={80} />
          </div>
          ...
          <div className={styles.jsreactImage}>
            <Image src="/jslogo.jpeg" alt="myImage" width={100} height={80} />
            <Image
              src="/reactlogo.jpeg"
              alt="myImage"
              width={100}
          ...
          <p className={styles.aboutpara2}>
            "I’m proficient in HTML, CSS, and JavaScript, and I’m 
     ...
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className={styles.conheaddiv}> 
